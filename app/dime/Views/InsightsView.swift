...
struct InsightsView: View {
    ...
    @AppStorage("chartTimeFrame", store: DimeDefaults.shared) var chartType = 1
...
struct SingleGraphView: View {
    ...
    @AppStorage("incomeTracking", store: DimeDefaults.shared) var incomeTracking: Bool = true
    ...
    @AppStorage("firstDayOfMonth", store: DimeDefaults.shared) var firstDayOfMonth: Int = 1
...
//        return abs(offset) > UIScreen.main.bounds.width * 0.3
    ...
    @AppStorage("insightsViewIncomeFiltering", store: DimeDefaults.shared) var income: Bool = true
    @AppStorage("incomeTracking", store: DimeDefaults.shared) var incomeTracking: Bool = true
...
//    @AppStorage("animated", store: DimeDefaults.shared) var animated: Bool = true
