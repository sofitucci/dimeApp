...
struct TransactionView: View {
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.sofitucci.dime")) var topEdge:
    Double = 20
    ...
    @AppStorage(
        "firstTransactionViewLaunch", store: UserDefaults(suiteName: "group.com.sofitucci.dime"))
